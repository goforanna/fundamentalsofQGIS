...
If you are not asked about where to place the folder and it just decompresses in the downloads folder, move the decompressed files into the easily accessible Data folder that you just created.

4. Now that the files are where it’s supposed to be, open the Data folder to make sure that you have 13 files.

Congratulations! You’ve downloaded the software and organized the project files! That process of data download/organization is a constant one when working with GIS. And as you collect more and more data for mapping, you’ll often re-use data in multiple projects, so it’s good that you’re forming data organization habits that will help you in the long run. Once you create your first project within QGIS, your file tree will look like this:

<img width="1200" height="1200" alt="SpatialDataManagementStructure" src="https://github.com/user-attachments/assets/933b57a7-6195-4024-8b0b-dbf1f847cb9a" />
